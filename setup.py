...
setup_kwargs = {
    ...
    'package_data': {'': []},
    'packages': ['ae'],
    'project_urls': {'Bug Tracker': 'https://gitlab.com/ae-group/ae_core/-/issues', 'Documentation': 'https://ae.readthedocs.io/en/latest/_autosummary/ae.core.html', 'Repository': 'https://gitlab.com/ae-group/ae_core', 'Source': 'https://ae.readthedocs.io/en/latest/_modules/ae/core.html'},
    'python_requires': '>=3.9',
