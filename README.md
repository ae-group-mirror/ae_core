<!-- THIS FILE IS EXCLUSIVELY MAINTAINED by the project ae.ae v0.3.108 -->
...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/ae-group/ae_core/release0.3.88?logo=python)](
    https://gitlab.com/ae-group/ae_core/-/tree/release0.3.88)
